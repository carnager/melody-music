...
data class PlaybackStatus(val state: String, val title: String, val artist: String, val album: String, val date: String, val albumId: String, val timePos: Double, val duration: Double, val rating: Int = 0, val songId: String = "", val currentSongPos: Int = -1, val playlistVersion: Int = 0, val playlistLength: Int = 0, val repeat: Boolean = false, val random: Boolean = false, val single: Boolean = false, val consume: Boolean = false, val replayGainMode: String = "off")
