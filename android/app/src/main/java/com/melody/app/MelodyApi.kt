...
data class PlaybackStatus(val state: String, val title: String, val artist: String, val album: String, val date: String, val albumId: String, val timePos: Double, val duration: Double, val rating: Int = 0, val songId: String = "", val currentSongPos: Int = -1)
